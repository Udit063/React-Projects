// src/components/Step4Review.js
import React from "react";
import { useForm } from "../context/FormContext";
const Step4Review = () => {
  const { formData, isSubmitted, updateFormData } = useForm();
    ...
    return (
      <div className="form-step submitted">
        ...
        <p className="success-message">
          Your form has been submitted successfully and saved to AWS DynamoDB.
        </p>
        <div className="next-steps">
          <h3>What happens next?</h3>
          <ul>
            <li>Your form data is securely stored in AWS DynamoDB</li>
            <li>You can view or manage this form from the dashboard</li>
            <li>Create new forms anytime using the dashboard</li>
          </ul>
        </div>
      </div>
    );
  ...
  return (
    <div className="form-step">
      ...
      <p className="step-description">
        Please review all the information you've provided before submitting to
        AWS DynamoDB.
      </p>
              ...
              <span className="value">
                {formData.contactFrequency
                  ? formData.contactFrequency.charAt(0).toUpperCase() +
                    formData.contactFrequency.slice(1)
                  : "Not specified"}
              </span>
            </div>
          </div>
      ...
      <div className="confirmation-checkbox">
        <label className="checkbox-label">
          ...
          />
          <span className="checkmark"></span>I confirm that all the information
