...
const FormDashboard = () => {
  ...
  const handleDeleteForm = async (formId, formTitle) => {
    if (
      window.confirm(`Are you sure you want to delete "${formTitle}"? This action
cannot be undone.`)
    ) {
  ...
  const getStatusBadge = (status) => {
    ...
    return (
      <span className={`status-badge ${config.color}`}>{config.text}</span>
    );
  };
  return (
    <div className="form-dashboard">
      ...
      <div className="forms-list">
        {loading ? (
          ...
          <div className="empty-state">
            ...
            <p>
              Create your first form to get started with AWS DynamoDB
              integration
            </p>
            <button
              onClick={() => setShowCreateForm(true)}
                ...
                <div className="form-card-body">
                  <div className="form-info">
                    ...
                    <div className="info-item">
                      ...
                      <span className="value">
                        {Object.keys(form.formData).length}
                        fields
                      </span>
                    </div>
                  </div>
      ...
      <div className="dashboard-footer">
        <p>
          ...
          <strong> Storage:</strong> AWS DynamoDB |<strong> Features:</strong>{" "}
